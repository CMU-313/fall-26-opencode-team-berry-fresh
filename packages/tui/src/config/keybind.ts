...
export const Definitions = {
  ...
  session_bookmarks: keybind("<leader>k", "Show bookmarked prompts"),
  bookmark_remove: keybind("ctrl+d", "Remove selected bookmark"),
  bookmark_toggle: keybind("ctrl+d", "Add or remove selected bookmark"),
...
export const CommandMap = {
  ...
  session_bookmarks: "session.bookmarks",
