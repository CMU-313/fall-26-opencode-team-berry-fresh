...
Explain code in a beginner-friendly way. Pass one or more files or directories to explain them, or leave it empty to get an overview of the whole project.

```bash frame="none"
/explain
/explain src/index.ts
/explain src/server src/client.ts
```
