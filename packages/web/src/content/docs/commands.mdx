...
Custom commands are in addition to the built-in commands like `/init`, `/explain`, `/undo`, `/redo`, `/share`, `/help`. [Learn more](/docs/tui#commands).
...
opencode includes several built-in commands like `/init`, `/explain`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
